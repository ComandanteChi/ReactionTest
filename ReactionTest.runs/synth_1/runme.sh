...
HD_PWD='C:/Users/Alex/Desktop/Programs/FPGA_projects/ReactionTest_V1.0/ReactionTest_V1.0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ReactionTest.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ReactionTest.tcl
